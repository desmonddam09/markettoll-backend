...
const updatePhoneNumberSchema = new mongoose.Schema(
  {
...
updatePhoneNumberSchema.index({ user: 1, 'phoneNumber.code': 1, 'phoneNumber.value': 1 }, { unique: true });

updatePhoneNumberSchema.statics.createOrUpdate = async function (_id, phoneNumber, otp) {
...
updatePhoneNumberSchema.statics.verifyOTP = async function (_id, phoneNumber, otp) {
...
export default mongoose.model('updatePhoneNumber', updatePhoneNumberSchema);
